...
if ($SocBreak) {
    ...
    $commands.Add("bt")
    $commands.Add("p/d net_current_ma")
    $commands.Add("p/x s_soc")
...
if ($RestFinish) {
    ...
    $commands.Add("p/x g_stCellInfoReport.u16Ichg")
    $commands.Add("p/x g_stCellInfoReport.u16IDischg")
    $commands.Add("p/x s_soc.rest_soc_ticks")
    $commands.Add("finish")
    $commands.Add("printf `"\n--- rest timer return ---\n`"")
    $commands.Add("p/x s_soc.mode")
    $commands.Add("p/x g_stCellInfoReport.u16Ichg")
    $commands.Add("p/x g_stCellInfoReport.u16IDischg")
    $commands.Add("p/x s_soc.rest_soc_ticks")
    $commands.Add("p/x s_soc.stable_rest_soc_ticks")
    $commands.Add("p/x s_soc.long_rest_down_soc_ticks")
    $commands.Add("p/x s_soc.rest_down_valid")
    $commands.Add("p/x s_soc.rest_down_target")
