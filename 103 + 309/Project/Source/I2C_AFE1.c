...
{
	watch->afe.registers_afe1 = &Registers_AFE1;
	watch->afe.read_afe1 = &SH367309_Read_AFE1;
	watch->tables.afe_ntc_10k = iSheldTemp_10K_AFE;
	watch->tables.afe_crc8 = CRC8Table;
}
#endif
