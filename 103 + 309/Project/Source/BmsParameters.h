...
电过流*/		BMS_SW_OCC1,			BMS_SW_OCC1,			50000,	10,\
	/*一级�

电过流延时*/	BMS_SW_OCC1_filter,	BMS_SW_OCC1_filter,	50000,	1,\
	/*二级�

电过流*/		BMS_SW_OCC2,			BMS_SW_OCC2,			50000,	10,\
	/*二级�

电过流延时*/	BMS_SW_OCC2_filter,	BMS_SW_OCC2_filter,	50000,	1,\
...
电高温*/			BMS_SW_OTC,	       BMS_SW_OTC,				2000,	400,\
	/*�

电高温恢复*/		BMS_SW_OTC_recover,	BMS_SW_OTC_recover,	50000,	1,\
	/*�

电低温*/			BMS_SW_UTC,	       BMS_SW_UTC,				800,	0,\
	/*�

电低温恢复*/		BMS_SW_UTC_recover,	BMS_SW_UTC_recover,	50000,	1,\
...
typedef struct{
	...
	BMS_PARAMETER_VALUE	u16IchgOcp_First;	//一级�

电过流 A*10
	BMS_PARAMETER_VALUE	u16IchgOcp_Filter_First;

	BMS_PARAMETER_VALUE	u16IchgOcp_Second;	//二级�
...
电过流
	...
	BMS_PARAMETER_VALUE	u16TChgOTp;			//�

电高温 (℃*10+400)
	BMS_PARAMETER_VALUE	u16TChgOTp_Rcv;
	BMS_PARAMETER_VALUE	u16TchgUTp;			//�
