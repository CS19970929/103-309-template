...
#define FLASH_ADDR_STORAGE_RUNTIME_SLOT_A ((UINT32)FLASH_ADDR_UPDATE_FLAG)
#define FLASH_ADDR_STORAGE_RUNTIME_SLOT_B ((UINT32)FLASH_ADDR_SLEEP_FLAG)
...
#define FLASH_STORAGE_RUNTIME_CLOCK_DATA_VERSION ((UINT16)0x0001)
...
typedef struct
{
	UINT16 u16FormatVersion;
	UINT16 u16Flags;
	UINT32 u32RuntimeSeconds;
	UINT32 u32SleepEntryEpochSeconds;
	UINT16 u16ReservedWords[4];
} STORAGE_FLASH_RUNTIME_CLOCK_DATA;
