...
简化soc软件架构，目前太过繁琐，去掉不必要的保底、冗余代码，保证模块稳定即可

梳理目前电流校准逻辑，待确认没问题，其他板子上后面也试试
梳理低功耗前、后，外设配置，是否有问题
暂时去掉soh、容量学习，只用于测试、观察，正式版本屏蔽掉，还没有确认是否好用
梳理宏配置,不同版本release、debug等版本，目前宏太多了，需要简化，必要的配置我来做，其他非重要配置不要让我配置，或者有其他更好的办法
