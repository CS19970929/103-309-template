...
调整进入rtc的逻辑CheckChargeMa，修改为通过充电电流大于500ma或者当检测到充电器识别5V，然后考虑soc是否会有问题，例如soc充到100，电池充到满电和充电器一样的42V电压，充电器继续接着电池，但由于电池和充电器同样电压，充电器不会充电了，bms目前的soc自耗逻辑，是否会导致soc下降到99，当然，当bms电压下降时，电池也会继续充电

目前的逻辑，在老化工厂模式下，也可以进入rtc低功耗逻辑，具体梳理下完整的老化逻辑，进入rtc低功耗后，是否会计时，计时到3天后，是否会永久退出老化模式

调整soc100参数


完整梳理目前的soc所有逻辑，包括所有细节、参数、校准逻辑，输出完整的文档我需要审核soc逻辑是否合适，并给出你的评价、看法，并根据soc逻辑进行完整场景测试