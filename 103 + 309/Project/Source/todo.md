...
先阅读文档、代码完整梳理我的需求，各模块的功能、需求，我要完全重写程序，要求架构简单、稳定目前整体太复杂了，特别是soc、低功耗写法
...
提供的文档中的 七、固件升级部分这一部分，中有升级协议，需要用这个协议来升级

我认为加一个mcu设备用于pc和bms通信方案比较好，pc和mcu可以串口通信，mcu和bms可以can通信用来升级，这样也不需要专门的can盒，也不需要专门的can上位机，你认为怎么样