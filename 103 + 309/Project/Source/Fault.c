...
void App_CellOvp_FirstCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag1)
	{
		...
		{
			g_stCellInfoReport.unMdlFault_First.bits.b1CellOvp = t_sPubOPUPChk.u8FlagBit; // ·µ»Ø¹ÊÕÏÅÐ¶Ï½á¹û
...
void App_CellUvp_FirstCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag1)
	{
		...
		if (App_PubOPUPChk(&t_sPubOPUPChk))
		{
			g_stCellInfoReport.unMdlFault_First.bits.b1CellUvp = t_sPubOPUPChk.u8FlagBit; // ·µ»Ø¹ÊÕÏÅÐ¶Ï½á¹û
			if (t_sPubOPUPChk.u8FlagBit == 1)
			{
...
void App_BatOvp_FirstCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag2)
	{
		...
		if (App_PubOPUPChk(&t_sPubOPUPChk))
		{
			g_stCellInfoReport.unMdlFault_First.bits.b1BatOvp = t_sPubOPUPChk.u8FlagBit; // ·µ»Ø¹ÊÕÏÅÐ¶Ï½á¹û
			if (t_sPubOPUPChk.u8FlagBit == 1)
			{
...
void App_BatUvp_FirstCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag2)
	{
		...
		if (App_PubOPUPChk(&t_sPubOPUPChk))
		{
			g_stCellInfoReport.unMdlFault_First.bits.b1BatUvp = t_sPubOPUPChk.u8FlagBit; // ·µ»Ø¹ÊÕÏÅÐ¶Ï½á¹û
			if (t_sPubOPUPChk.u8FlagBit == 1)
			{
...
void App_IchgOcp_FirstCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag3)
	{
		...
		t_sPubOPUPChk.u16OPValB = PRT_E2ROMParas.u16IchgOcp_First;		// ¹ýÁ÷ÅÐ¶Ï
		t_sPubOPUPChk.u16OPValS = PRT_E2ROMParas.u16IchgOcp_First - 10; // Ã»ÓÐ»Ö¸´ÅÐ¶Ï
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		...
		if (App_PubOPUPChk(&t_sPubOPUPChk))
		{
			g_stCellInfoReport.unMdlFault_First.bits.b1IchgOcp = t_sPubOPUPChk.u8FlagBit; // ·µ»Ø¹ÊÕÏÅÐ¶Ï½á¹û
			if (t_sPubOPUPChk.u8FlagBit == 1)
			{
...
void App_IdischgOcp_FirstCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag3)
	{
		...
		t_sPubOPUPChk.u16OPValB = PRT_E2ROMParas.u16IdsgOcp_First;		// ¹ýÁ÷ÅÐ¶Ï
		t_sPubOPUPChk.u16OPValS = PRT_E2ROMParas.u16IdsgOcp_First - 10; // Ã»ÓÐ»Ö¸´ÅÐ¶Ï
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		...
		if (App_PubOPUPChk(&t_sPubOPUPChk))
		{
			g_stCellInfoReport.unMdlFault_First.bits.b1IdischgOcp = t_sPubOPUPChk.u8FlagBit; // ·µ»Ø¹ÊÕÏÅÐ¶Ï½á¹û
			if (t_sPubOPUPChk.u8FlagBit == 1)
			{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag4)
	{
		...
		case 0:
			if (g_stCellInfoReport.u16Ichg > OTP_UTP_VirCur_Chg)
			{
				if (App_PubOPUPChk(&t_sPubOPUPChk))
				{
					g_stCellInfoReport.unMdlFault_First.bits.b1CellChgOtp = t_sPubOPUPChk.u8FlagBit; // ·µ»Ø¹ÊÕÏÅÐ¶Ï½á¹û
					if (t_sPubOPUPChk.u8FlagBit == 1)
					{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag4)
	{
		...
		case 0:
			if (g_stCellInfoReport.u16IDischg > OTP_UTP_VirCur_Dsg)
			{
				if (App_PubOPUPChk(&t_sPubOPUPChk))
				{
					g_stCellInfoReport.unMdlFault_First.bits.b1CellDischgOtp = t_sPubOPUPChk.u8FlagBit; // ·µ»Ø¹ÊÕÏÅÐ¶Ï½á¹û
					if (t_sPubOPUPChk.u8FlagBit == 1)
					{
...
void App_MosOtp_FirstCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag5)
	{
		...
		if (App_PubOPUPChk(&t_sPubOPUPChk))
		{
			g_stCellInfoReport.unMdlFault_First.bits.b1TmosOtp = t_sPubOPUPChk.u8FlagBit; // ·µ»Ø¹ÊÕÏÅÐ¶Ï½á¹û
			if (t_sPubOPUPChk.u8FlagBit == 1)
			{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag5)
	{
		...
		case 0:
			if (g_stCellInfoReport.u16Ichg > OTP_UTP_VirCur_Chg)
			{
				if (App_PubOPUPChk(&t_sPubOPUPChk))
				{
					g_stCellInfoReport.unMdlFault_First.bits.b1CellChgUtp = t_sPubOPUPChk.u8FlagBit; // ·µ»Ø¹ÊÕÏÅÐ¶Ï½á¹û
					if (t_sPubOPUPChk.u8FlagBit == 1)
					{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag5)
	{
		...
		case 0:
			if (g_stCellInfoReport.u16IDischg > OTP_UTP_VirCur_Dsg)
			{
				if (App_PubOPUPChk(&t_sPubOPUPChk))
				{
					g_stCellInfoReport.unMdlFault_First.bits.b1CellDischgUtp = t_sPubOPUPChk.u8FlagBit; // ·µ»Ø¹ÊÕÏÅÐ¶Ï½á¹û
					if (t_sPubOPUPChk.u8FlagBit == 1)
					{
...
void App_CellSocUp_FirstCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag4)
	{
		...
		if (App_PubOPUPChk(&t_sPubOPUPChk))
		{
			g_stCellInfoReport.unMdlFault_First.bits.b1SocLow = t_sPubOPUPChk.u8FlagBit; // ·µ»Ø¹ÊÕÏÅÐ¶Ï½á¹û
			if (t_sPubOPUPChk.u8FlagBit == 1)
			{
...
void App_VdeltaOp_FirstCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag5)
	{
		...
		if (App_PubOPUPChk(&t_sPubOPUPChk))
		{
			g_stCellInfoReport.unMdlFault_First.bits.b1VcellDeltaBig = t_sPubOPUPChk.u8FlagBit; // ·µ»Ø¹ÊÕÏÅÐ¶Ï½á¹û
			if (t_sPubOPUPChk.u8FlagBit == 1)
			{
