...
enum LOW_POWER_RTC_BLOCK_REASON {
  ...
  LOW_POWER_RTC_BLOCK_CHARGE_INPUT,
  ...
  LOW_POWER_RTC_BLOCK_SYSTEM_FAULT,
  LOW_POWER_RTC_BLOCK_FLASH_BUSY,
  LOW_POWER_RTC_BLOCK_UPGRADE,
  LOW_POWER_RTC_BLOCK_IWDG_UNSAFE
};
