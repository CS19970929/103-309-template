...
#define CHARGE_CTRL_PROBE_IDLE_MS             ((UINT32)(1 * 1000u))
...
#define CHARGE_CTRL_FULL_TAPER_CONFIRM_MS     ((UINT32)(5 * 1000u))
#define CHARGE_CTRL_FULL_VOLT_CONFIRM_MS      ((UINT32)(5 * 1000u))
#define CHARGE_CTRL_RECHARGE_CONFIRM_MS       ((UINT32)(1 * 1000u))
...
#define CHARGE_CTRL_RECHARGE_CELL_MV          ((UINT16)4150u)
