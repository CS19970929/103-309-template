...
struct OTHER_ELEMENT {
	...
	// uint32_t u16Sleep_TimeNormal;		//min
...
#define  BMS_SOFTWARE_VERDION_DEFAULT   "a002-240322-c022v4p0"  //32
...
#define CS_Cur_CHGmax			(CS_Res_Num * 200 * 10 / CS_Res)
#define CS_Cur_DSGmax			CS_Cur_CHGmax
...
extern	uint16_t I_CHG ;
extern	uint16_t I_DSG ;
