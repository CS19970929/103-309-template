...
| `PROJECT_CFG_SOC_REST_STABLE_MIN_SECONDS` | 300 | 稳定最短时间 (5分钟) |
| `PROJECT_CFG_SOC_REST_TARGET_STEP_SECONDS` | 600 | 每步更新时间 (10分钟) |
| `PROJECT_CFG_SOC_REST_DOWN_STEP_SECONDS` | 1800 | 长时间下调步长 (30分钟) |
