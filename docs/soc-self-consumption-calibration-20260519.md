...
- 末端渐进校准：接近满电或空电阈值时按多级计时逐步拉近 SOC，减少长时间卡在 99% 或 1%。
- 静置 OCV：无充放电电流持续 300s 后启用，超过 5% 死区才每 60s 修正 1%，避免静置跳变。
...
- 满空端点和 OCV 校准优先级高于自耗，避免自耗干扰校准判断。
