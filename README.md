...
7. [103 + 309 重写完成度与剩余边界](REWRITE_COMPLETION_STATUS_2026-05-13.md)
...
| [103 + 309 重写完成度与剩余边界](REWRITE_COMPLETION_STATUS_2026-05-13.md) | 是否可替代旧代码、Keil 编译状态、CI/port 含义和上板前剩余验收 |
