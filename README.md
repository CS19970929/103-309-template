...
2. [项目运行流程与时序源码梳理](项目运行流程与时序源码梳理_2026-05-16.md)
3. [MCU 资源分布与架构优化评估](MCU资源分布与架构优化评估.md)
4. [系统时钟系统梳理](系统时钟系统梳理.md)
5. [运行架构与时基重构方案](运行架构与时基重构方案.md)
6. [可移植解耦基础层说明](PORTABILITY_DECOUPLING_FOUNDATION_2026-05-16.md)
7. [软硬件保护策略配置说明](PROTECTION_STRATEGY_CONFIG_2026-05-16.md)
8. [System_Monitor 模块梳理](System_Monitor模块梳理.md)
9. [项目宏定义梳理](项目宏定义梳理.md)
10. [休眠低功耗逻辑梳理与优化建议](休眠低功耗逻辑梳理与优化建议.md)
11. [LED 软件框架与时序梳理](LED软件框架与时序梳理.md)
...
| [可移植解耦基础层说明](PORTABILITY_DECOUPLING_FOUNDATION_2026-05-16.md) | 模块裁剪开关、平台 port、运行数据访问边界和 STM32F0 移植路线 |
| [软硬件保护策略配置说明](PROTECTION_STRATEGY_CONFIG_2026-05-16.md) | SH367309 硬件保护、MCU 软件保护和 hybrid 保护模式的一键切换边界 |
