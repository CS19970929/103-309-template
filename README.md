...
1. [MCU 资源分布与架构优化评估](MCU资源分布与架构优化评估.md)
2. [系统时钟系统梳理](系统时钟系统梳理.md)
3. [System_Monitor 模块梳理](System_Monitor模块梳理.md)
4. [项目宏定义梳理](项目宏定义梳理.md)
5. [休眠低功耗逻辑梳理与优化建议](休眠低功耗逻辑梳理与优化建议.md)
6. [LED 软件框架与时序梳理](LED软件框架与时序梳理.md)
...
4. [App_AnlogCal 时基修改影响说明](App_AnlogCal时基修改影响说明.md)
5. [MonitorAFE 逻辑优化说明](MONITOR_AFE_LOGIC_OPTIMIZATION.md)
6. [后 64K SOC/AFE 参数快速测试说明](后64K_SOC_AFE快速测试说明.md)
