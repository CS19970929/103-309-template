...
1. [103 + 309 程序重写架构总纲](REWRITE_ARCHITECTURE_PLAN.md)
2. [项目级代码与文档审查记录](PROJECT_REVIEW_2026-05-09.md)
3. [MCU 资源分布与架构优化评估](MCU资源分布与架构优化评估.md)
4. [系统时钟系统梳理](系统时钟系统梳理.md)
5. [System_Monitor 模块梳理](System_Monitor模块梳理.md)
6. [项目宏定义梳理](项目宏定义梳理.md)
7. [休眠低功耗逻辑梳理与优化建议](休眠低功耗逻辑梳理与优化建议.md)
8. [LED 软件框架与时序梳理](LED软件框架与时序梳理.md)
...
3. [SOC 无板主机验证方案](SOC_HOST_VALIDATION_PLAN.md)
4. [STM32F103 ADC 配置调研与当前工程方案](ADC_配置调研与当前方案.md)
5. [Type-C ADC 电流采样与计算说明](TypeC_ADC电流采样与计算说明.md)
6. [ADC 总压分压计算说明](ADC总压分压计算说明.md)
7. [App_AnlogCal 时基修改影响说明](App_AnlogCal时基修改影响说明.md)
8. [MonitorAFE 逻辑优化说明](MONITOR_AFE_LOGIC_OPTIMIZATION.md)
9. [后 64K SOC/AFE 参数快速测试说明](后64K_SOC_AFE快速测试说明.md)
...
| 文档 | 内容定位 |
| --- | --- |
| [103 + 309 程序重写架构总纲](REWRITE_ARCHITECTURE_PLAN.md) | 重写目标、Flash/IAP 边界、模块分层、SOC/低功耗简化策略和验证门禁 |
